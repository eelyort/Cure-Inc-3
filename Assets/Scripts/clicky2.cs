...
public class clicky2 : MonoBehaviour {
    // Color[] data;
    ...
    void Awake() {
        ...
        /*
        // set scales equal
        RectTransform colorMapTransform = colorMap.GetComponent<RectTransform>();
    ...
    private bool IntersectsTexture(Texture2D texture, Ray ray, out Color color, Sprite sprite) {
        ...
        */
        ...
        Vector3 spritePos = colorMap.transform.worldToLocalMatrix.MultiplyPoint3x4(ray.origin + (ray.direction * rayIntersectDist));
